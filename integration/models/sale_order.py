...
class SaleOrder(models.Model):
    ...
    # TODO: Move to Shopify connector
    ...
    def _integration_paid_order_hook(self):
        ...
        action_after_paid = self.order_is_fully_paid or self.env.context.get('force_export_paid_status')
    ...
    def action_open_order_in_external_system(self):
        ...
        return {
            ...
            'url': self.integration_id.get_order_url(self.related_input_files.name),
            'target': 'new',
        }
