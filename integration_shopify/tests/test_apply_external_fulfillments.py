...
class TestIntegrationShopifyFulfillments(IntegrationShopifyBase):
    ...
    def test_single_external_wh_with_odoo_multisource(self):
        ...
        self.assertEqual(int(picking.move_ids.move_line_ids.qty_done), 1)
        ...
        self.assertEqual(int(picking.move_ids[0].move_line_ids.qty_done), 2)
        ...
        self.assertEqual(int(picking.move_ids[1].move_line_ids.qty_done), 1)
    ...
    def test_multiple_external_wh_with_odoo_multisource(self):
        ...
        self.assertEqual(int(picking.move_ids[0].move_line_ids.qty_done), 1)
