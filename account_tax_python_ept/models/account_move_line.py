    ...
    def _compute_tax_totals(self):
        ...
        for move in self:
            if move.is_invoice(include_receipts=True):
                ...
                base_line_values_list = [line.with_context(
                    tax_computation_context={'line_tax_amount_percent':line.line_tax_amount_percent}
...
class AccountMoveLine(models.Model):
    ...
    @api.depends('tax_ids', 'currency_id', 'partner_id', 'analytic_distribution', 'balance',
                 'partner_id', 'move_id.partner_id', 'price_unit', 'line_tax_amount_percent', 'quantity')
