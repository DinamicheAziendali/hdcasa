...

{
    ...
    'data': [
        ...
        'view/inbound_shipment_plan_new_ept.xml',
        'wizard_views/inbound_shipment_plan_new_check_status_ept_view.xml',
        'wizard_views/list_placement_options.xml',
        'view/inbound_shipment_new_ept.xml',
        'wizard_views/list_packing_options.xml',
        'wizard_views/list_transportation_options.xml',
        'wizard_views/list_delivery_window_options.xml',
        'view/carton_content_information.xml',
        'wizard_views/new_inbound_shipment_labels_wizard.xml',
        'view/amz_transportation_options.xml',
        'data/amazon.replacement.order.reason.code.csv',
        'view/replacement_order_reason.xml',
